...
This artifact contains a dataset with the project's major results, microservices used, and a `README` with the steps on how to build and run the Granify method to replicate the results.
